...
public class DeleteUserBasedOnUserRole {
	...
	WebDriver driver;
	  ...
	  public void Add_User() throws InterruptedException
	  {
		  ...
		  //Delete User and verify user deletion
		  
		  driver.findElement(By.xpath("//a[text()='"+expName+"']//parent::td/../td[text()='ESS']//parent::td/preceding-sibling::td/input")).click();
		  driver.findElement(By.id("btnDelete")).click();
		  driver.findElement(By.id("dialogDeleteBtn")).click();
		  Thread.sleep(5000);
		  boolean bExist = driver.getPageSource().contains(expName);
		  Assert.assertFalse(bExist);
